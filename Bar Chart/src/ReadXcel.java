...
public class ReadXcel {
    ...
    public void baca() throws IOException{
        FileInputStream fis = new FileInputStream(new File("E:\\Mata Kuliah\\Semester 2\\Proyek\\Data.xlsx"));
      
        XSSFWorkbook workbook = new XSSFWorkbook(fis);
        XSSFSheet spreadsheet = workbook.getSheetAt(1); //Read sheet pertama
